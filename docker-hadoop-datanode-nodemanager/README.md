## Docker Hadoop Datanode Nodemanager
This image is for Hadoop datanode and YARN nodemanager. 
This is based on the docker-hadoop-base image and contains the startup script for datanode and nodemanager (start-hadoop-datanode-nodemanager).
